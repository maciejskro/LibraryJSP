...
public class BookDTO {
    ...
    public BookDTO(Long id, @NotEmpty @Length(min = 2, max = 50) String title, String autorName, LocalDate releaseDate,
                   Integer pages, String ISBN, String booksType, Boolean isBorrow, String description, String borrowerName) {
        this.id = id;
        this.title = title;
